...
- 严格理论层：未完成。仍有 8.1 中列出的三类缺口（更细再分辨一致化、走势类型一体化、尾部临界解释层）。

“8.2 当前仍待落地：无”仅表示该矩阵清单已完成，不代表严格理论层缺口为零。
...
| 严格理论 | 未完全完成 | 仍有更细再分辨、走势类型一体化、尾部临界语义三类缺口。 |
...
说明：本节是“严格理论层”的剩余项，与 8.2 的工程矩阵完成状态并不冲突。
