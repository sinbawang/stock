...
- 这说明当前前端可见级别已经有“watch/pending”“前段完成后新段运行中”“正式向下预警未确认”“正式向上预警未确认”“真实 confirmed 卖点”“真实 confirmed 买点 live”“真实 confirmed 买点 replay”“预警前态代理”多类稳定消费案例，并额外有一条 confirmed regression reference；`candidate_new_type` 当前改由历史原型 + 扫描工具补位。
